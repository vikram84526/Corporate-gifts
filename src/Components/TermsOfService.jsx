      ...
      <div className="max-w-5xl w-full space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-400">
            ...
            partners. You may not copy, reproduce, or redistribute any material
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-400">
            ...
            the total price. We reserve the right to refuse or cancel any order
            in case of pricing errors, fraud suspicion, or stock unavailability.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-400">
            ...
            our website after such updates constitutes acceptance of the revised
            terms.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-amber-400">6. Contact</h2>
          <p className="text-gray-400">
